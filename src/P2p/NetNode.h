...
#include "TycheCashCore/OnceInInterval.h"
...
namespace TycheCash
{
  ...
  struct P2pConnectionContext : public TycheCashConnectionContext {
  public:
    ...
    P2pConnectionContext(P2pConnectionContext&& ctx) : 
      TycheCashConnectionContext(std::move(ctx)),
      context(ctx.context),
      peerId(ctx.peerId),
  ...
  public:
    ...
    NodeServer(System::Dispatcher& dispatcher, TycheCash::TycheCashProtocolHandler& payload_handler, Logging::ILogger& log);
    ...
    TycheCash::TycheCashProtocolHandler& get_payload_object();
    ...
    TycheCash::PeerlistManager& getPeerlistManager() { return m_peerlist; }
  ...
  private:
    ...
    bool handshake(TycheCash::LevinProtocol& proto, P2pConnectionContext& context, bool just_take_peerlist = false);
    bool timedSync();
    ...
    virtual bool invoke_notify_to_peer(int command, const BinaryArray& req_buff, const TycheCashConnectionContext& context) override;
    ...
    bool idle_worker();
    bool handle_remote_peerlist(const std::list<PeerlistEntry>& peerlist, time_t local_time, const TycheCashConnectionContext& context);
    ...
    TycheCashProtocolHandler& m_payload_handler;
