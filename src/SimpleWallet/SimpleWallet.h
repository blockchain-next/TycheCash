...
namespace TycheCash
{
  ...
  /*                                                                      */
  /************************************************************************/
  class simple_wallet : public TycheCash::INodeObserver, public TycheCash::IWalletLegacyObserver, public TycheCash::INodeRpcProxyObserver {
  public:
    simple_wallet(System::Dispatcher& dispatcher, const TycheCash::Currency& currency, Logging::LoggerManager& log);
  ...
  private:
    ...
    {
    public:
      refresh_progress_reporter_t(TycheCash::simple_wallet& simple_wallet)
    ...
    private:
      TycheCash::simple_wallet& m_simple_wallet;
  ...
  private:
    ...
    std::unique_ptr<TycheCash::NodeRpcProxy> m_node;
    std::unique_ptr<TycheCash::IWalletLegacy> m_wallet;
