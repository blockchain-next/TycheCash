...
inline std::error_code make_error_code(TycheCash::error::NodeErrorCodes e) {
  return std::error_code(static_cast<int>(e), TycheCash::error::NodeErrorCategory::INSTANCE);
}
