...
inline std::error_code make_error_code(TycheCash::error::WalletErrorCodes e) {
  return std::error_code(static_cast<int>(e), TycheCash::error::WalletErrorCategory::INSTANCE);
}

namespace std {

template <>
struct is_error_code_enum<TycheCash::error::WalletErrorCodes>: public true_type {};
