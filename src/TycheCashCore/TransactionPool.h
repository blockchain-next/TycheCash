...
#include "TycheCashCore/ITimeProvider.h"
#include "TycheCashCore/ITransactionValidator.h"
#include "TycheCashCore/ITxPoolObserver.h"
...
namespace TycheCash {
  ...
  public:
    OnceInTimeInterval(unsigned interval, TycheCash::ITimeProvider& timeProvider)
  ...
  private:
    ...
    unsigned m_interval;
    TycheCash::ITimeProvider& m_timeProvider;
  };
  ...
  private:
    ...
    TycheCash::ITransactionValidator& m_validator;
    TycheCash::ITimeProvider& m_timeProvider;
