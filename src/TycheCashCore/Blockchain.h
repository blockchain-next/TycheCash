...
#include "TycheCashCore/BlockIndex.h"
#include "TycheCashCore/Checkpoints.h"
#include "TycheCashCore/Currency.h"
#include "TycheCashCore/IBlockchainStorageObserver.h"
#include "TycheCashCore/ITransactionValidator.h"
#include "TycheCashCore/SwappedVector.h"
...
#include "TycheCashCore/MessageQueue.h"
#include "TycheCashCore/BlockchainMessages.h"
#include "TycheCashCore/IntrusiveLinkedList.h"
...
namespace TycheCash {
  ...
  using TycheCash::BlockInfo;
  class Blockchain : public TycheCash::ITransactionValidator {
  public:
    ...
    bool handleGetObjects(NOTIFY_REQUEST_GET_OBJECTS_request& arg, NOTIFY_RESPONSE_GET_OBJECTS_request& rsp); //Deprecated. Should be removed with TycheCashProtocolHandler.
  ...
  private:
    ...
    Blocks m_blocks;
    TycheCash::BlockIndex m_blockIndex;
