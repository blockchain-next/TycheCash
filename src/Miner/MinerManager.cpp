...
MinerManager::MinerManager(System::Dispatcher& dispatcher, const TycheCash::MiningConfig& config, Logging::ILogger& logger) :
...
void MinerManager::startMining(const TycheCash::BlockMiningParameters& params) {
...
void MinerManager::adjustBlockTemplate(TycheCash::Block& blockTemplate) const {
