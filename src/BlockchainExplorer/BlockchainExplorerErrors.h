...
inline std::error_code make_error_code(TycheCash::error::BlockchainExplorerErrorCodes e) {
  return std::error_code(static_cast<int>(e), TycheCash::error::BlockchainExplorerErrorCategory::INSTANCE);
}
