...
public:
  RpcServer(System::Dispatcher& dispatcher, Logging::ILogger& log, core& c, NodeServer& p2p, const ITycheCashProtocolQuery& protocolQuery);
...
private:
  ...
  core& m_core;
  NodeServer& m_p2p;
  const ITycheCashProtocolQuery& m_protocolQuery;
};
