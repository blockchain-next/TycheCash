...
public:
  WalletLegacy(const TycheCash::Currency& currency, INode& node);
...
private:
  ...
  TycheCash::AccountBase m_account;
  ...
  Tools::ObserverManager<TycheCash::IWalletLegacyObserver> m_observerManager;
