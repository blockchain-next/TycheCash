...
public:
  ...
  bool serialize(TycheCash::ISerializer& serializer);
  ...
  void updateTransaction(TransactionId transactionId, const TycheCash::Transaction& tx, uint64_t amount, const std::list<TransactionOutputInformation>& usedOutputs);
