...
std::error_code walletSaveWrapper(TycheCash::IWalletLegacy& wallet, std::ofstream& file, bool saveDetailes, bool saveCache) {
  TycheCash::WalletHelper::SaveWalletResultObserver o;
...
void WalletHelper::SendCompleteResultObserver::sendTransactionCompleted(TycheCash::TransactionId transactionId, std::error_code result) {
  std::lock_guard<std::mutex> lock(m_mutex);
  m_finishedTransactions[transactionId] = result;
  m_condition.notify_one();
}

std::error_code WalletHelper::SendCompleteResultObserver::wait(TycheCash::TransactionId transactionId) {
...
WalletHelper::IWalletRemoveObserverGuard::IWalletRemoveObserverGuard(TycheCash::IWalletLegacy& wallet, TycheCash::IWalletLegacyObserver& observer) :
  m_wallet(wallet),
  m_observer(observer),
  m_removed(false) {
...
void WalletHelper::storeWallet(TycheCash::IWalletLegacy& wallet, const std::string& walletFilename) {
