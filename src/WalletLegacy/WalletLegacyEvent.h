...
public:
  ...
  virtual void notify(Tools::ObserverManager<TycheCash::IWalletLegacyObserver>& observer) = 0;
};
...
public:
  ...
  virtual void notify(Tools::ObserverManager<TycheCash::IWalletLegacyObserver>& observer) override
  {
