...
namespace {
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterANodeIsConnectedToAnotherIfTheirBlockchainsAreSynchronized) {
    ...
    std::unique_ptr<TycheCash::INode> node0;
    std::unique_ptr<TycheCash::INode> node1;
    std::unique_ptr<TycheCash::INode> node2;
    std::unique_ptr<TycheCash::INode> node3;
    ...
    std::vector<std::unique_ptr<TycheCash::ITransactionReader>> poolTxs1;
    std::vector<std::unique_ptr<TycheCash::ITransactionReader>> poolTxs2;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterTimedBlockchainsSynchronization) {
    ...
    std::unique_ptr<TycheCash::INode> node2;
    std::unique_ptr<TycheCash::INode> node3;
    std::unique_ptr<TycheCash::INode> node4;
    ...
    std::vector<std::unique_ptr<TycheCash::ITransactionReader>> poolTxs2;
    std::vector<std::unique_ptr<TycheCash::ITransactionReader>> poolTxs3;
    std::vector<std::unique_ptr<TycheCash::ITransactionReader>> poolTxs4;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterSwitchingToAlternativeChain) {
    ...
    TycheCash::Block blockTemplate2;
