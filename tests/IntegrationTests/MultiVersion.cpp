...
public:
  ...
  MultiVersionTest(const TycheCash::Currency& currency, System::Dispatcher& d, const Tests::Common::BaseFunctionalTestsConfig& config, Logging::ILogger& log) :
  ...
  void run() {
    ...
    TycheCash::AccountBase stashAddress;
