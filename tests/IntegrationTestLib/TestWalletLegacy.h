...
class TestWalletLegacy : private TycheCash::IWalletLegacyObserver {
public:
  TestWalletLegacy(System::Dispatcher& dispatcher, const TycheCash::Currency& currency, TycheCash::INode& node);
  ~TestWalletLegacy();
  ...
  TycheCash::IWalletLegacy* wallet();
  TycheCash::AccountPublicAddress address() const;
...
private:
  ...
  std::unique_ptr<TycheCash::IWalletLegacyObserver> m_walletObserver;
