...
public:
  ...
  bool mark_invalid_tx(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool mark_invalid_block(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool check_double_spend(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry>& events);

private:
  TycheCash::Block m_last_valid_block;
...
protected:
  ...
  TycheCash::KeyPair m_outputTxKey;
