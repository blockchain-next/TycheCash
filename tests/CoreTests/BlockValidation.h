...
public:
  ...
  bool check_block_purged(TycheCash::core& c, size_t eventIdx, const std::vector<test_event_entry>& events) {
  ...
  bool markInvalidBlock(TycheCash::core& c, size_t eventIdx, const std::vector<test_event_entry>& events) {
...
struct CheckBlockAccepted : public test_chain_unit_base {
  ...
  bool check_block_accepted(TycheCash::core& c, size_t /*eventIdx*/, const std::vector<test_event_entry>& /*events*/) {
...
struct gen_block_invalid_binary_format : public test_chain_unit_base
{
  ...
  bool generate(std::vector<test_event_entry>& events) const;
  bool check_block_verification_context(const TycheCash::block_verification_context& bvc, size_t event_idx, const TycheCash::Block& /*blk*/);
  bool check_all_blocks_purged(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool corrupt_blocks_boundary(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
