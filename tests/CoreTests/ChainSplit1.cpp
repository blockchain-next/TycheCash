...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_mempool_2(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_mempool_1(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<TycheCash::Block>(events[8])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 2);
  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched2(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<TycheCash::Block>(events[14])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 3);
  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched_back(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<TycheCash::Block>(events[19])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 8);

  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched_back_1(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<TycheCash::Block>(events[26])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 8);

  return true;
}//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched_back_2(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<TycheCash::Block>(events[28])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 8);
  return true;
}
//-----------------------------------------------------------------------------------------------------
/*
bool gen_simple_chain_split_1::check_orphaned_chain_1(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_switched_to_alternative(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_2(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_switched_to_main(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_38(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_39(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_40(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_41(TycheCash::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
