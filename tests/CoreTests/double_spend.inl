...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::check_tx_verification_context(const TycheCash::tx_verification_context& tvc, bool tx_added, size_t event_idx, const TycheCash::Transaction& /*tx*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::check_block_verification_context(const TycheCash::block_verification_context& bvc, size_t event_idx, const TycheCash::Block& /*block*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_last_valid_block(TycheCash::core& c, size_t /*ev_index*/, const std::vector<test_event_entry>& /*events*/)
{
  std::list<TycheCash::Block> block_list;
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_invalid_tx(TycheCash::core& /*c*/, size_t ev_index, const std::vector<test_event_entry>& /*events*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::mark_invalid_block(TycheCash::core& /*c*/, size_t ev_index, const std::vector<test_event_entry>& /*events*/)
{
...
template<class concrete_test>
bool gen_double_spend_base<concrete_test>::check_double_spend(TycheCash::core& c, size_t /*ev_index*/, const std::vector<test_event_entry>& events)
{
  ...
  TycheCash::AccountBase bob_account = boost::get<TycheCash::AccountBase>(events[1]);
  TycheCash::AccountBase alice_account = boost::get<TycheCash::AccountBase>(events[2]);

  std::vector<TycheCash::Block> chain;
  map_hash2tx_t mtx;
  std::vector<TycheCash::Block> blocks(block_list.begin(), block_list.end());
...
bool gen_double_spend_in_tx<txs_keeped_by_block>::generate(std::vector<test_event_entry>& events) const
{
  ...
  TycheCash::TransactionSourceEntry se;
  se.amount = tx_0.outputs[0].amount;
  se.outputs.push_back(std::make_pair(0, boost::get<TycheCash::KeyOutput>(tx_0.outputs[0].target).key));
  se.realOutput = 0;
  se.realTransactionPublicKey = TycheCash::getTransactionPublicKeyFromExtra(tx_0.extra);
  se.realOutputIndexInTransaction = 0;
  sources.push_back(se);
  // Double spend!
  sources.push_back(se);

  TycheCash::TransactionDestinationEntry de;
...
bool gen_double_spend_in_the_same_block<txs_keeped_by_block>::generate(std::vector<test_event_entry>& events) const
{
  ...
  TycheCash::Transaction tx_1 = txs_1.front();
